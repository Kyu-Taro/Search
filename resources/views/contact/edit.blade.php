            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('contact.update', ['id' => $contact->id]) }}">
                        ...
                        <br>
                        性別<br>
                        <input type="radio" name="gender" value="0" @if($contact->gender === 0) checked @endif>男性<br>
                        ...
                        <select name="age">
                            ...
                            <option vlaue="2" @if($contact->age === 2) selected @endif>20歳〜29歳</option>
                            <option vlaue="3" @if($contact->age === 3) selected @endif>30歳〜39歳</option>
